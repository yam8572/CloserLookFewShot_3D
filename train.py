...
if __name__ == '__main__':
    ...
    if params.method in ['baseline', 'baseline++']:
        ...
        base_datamgr = SetDataManager(
            image_size, n_views=params.num_views, n_query=n_query, **train_few_shot_params)
        base_loader = base_datamgr.get_data_loader(
            base_file, aug=params.train_aug)
        ...
        val_datamgr = SetDataManager(
            image_size, n_views=params.num_views, n_query=n_query, **test_few_shot_params)
        val_loader = val_datamgr.get_data_loader(val_file, aug=False)
        # a batch for SetDataManager: a [n_way, n_support + n_query, dim, w, h] tensor

        if params.method == 'protonet':
            model = ProtoNet(model_dict[params.model],
                             params.num_views, **train_few_shot_params)
